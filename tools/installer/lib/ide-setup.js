...
class IdeSetup extends BaseIdeSetup {
  ...
  async setupOpenCode(installDir, selectedAgent, spinner = null, preConfiguredSettings = null) {
    ...
    const generateOpenCodeAgentsMd = async () => {
      try {
        ...
        section += `- Refresh this section after BMAD updates: \`npx -p bmad-drj bmad-method install -f -i opencode\`.\n\n`;

        section += `### Helpful Commands\n\n`;
        section += `- List agents: \`npx -p bmad-drj bmad-method list:agents\`\n`;
        section += `- Reinstall BMAD core and regenerate this section: \`npx -p bmad-drj bmad-method install -f -i opencode\`\n`;
        section += `- Validate configuration: \`npx -p bmad-drj bmad-method validate\`\n\n`;
  ...
  async setupCodex(installDir, selectedAgent, options) {
    ...
    section += `- Refresh this section after agent updates: \`npx -p bmad-drj bmad-method install -f -i codex\`.\n\n`;

    section += `### Helpful Commands\n\n`;
    section += `- List agents: \`npx -p bmad-drj bmad-method list:agents\`\n`;
    section += `- Reinstall BMAD core and regenerate AGENTS.md: \`npx -p bmad-drj bmad-method install -f -i codex\`\n`;
    section += `- Validate configuration: \`npx -p bmad-drj bmad-method validate\`\n\n`;
