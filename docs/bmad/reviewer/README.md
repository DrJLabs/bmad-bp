...
4. **Sync telemetry** — `npm run reviewer:telemetry-sync -- --metrics artifacts/reviewer --tracker docs/bmad/issues/reviewer-rollout.md`.
...
4. Sync metrics to the rollout tracker with `npm run reviewer:telemetry-sync -- --metrics artifacts/reviewer --tracker docs/bmad/issues/reviewer-rollout.md [--mode strict]`. The command accepts a directory and automatically discovers the most recent run.
...
- Append metrics to `docs/bmad/issues/reviewer-rollout.md` using `npm run reviewer:telemetry-sync -- --metrics artifacts/reviewer --tracker docs/bmad/issues/reviewer-rollout.md`.
