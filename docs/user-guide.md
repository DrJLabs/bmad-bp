...
- Installation:
  - Run `npx -p bmad-drj bmad-method install` and choose `OpenCode` in the IDE list.
...
- Refresh after changes:
  - Re-run:
    ```bash
    npx -p bmad-drj bmad-method install -f -i opencode
    ```
...
- **GitHub Issues**: [Report bugs](https://github.com/DrJLabs/bmad-bp/issues)
- **Documentation**: [Browse docs](https://github.com/DrJLabs/bmad-bp/tree/main/docs)
