...
npx -p bmad-drj bmad-method flatten

# Specify custom input directory
npx -p bmad-drj bmad-method flatten --input /path/to/source/directory
npx -p bmad-drj bmad-method flatten -i /path/to/source/directory

# Specify custom output file
npx -p bmad-drj bmad-method flatten --output my-project.xml
npx -p bmad-drj bmad-method flatten -o /path/to/output/codebase.xml

# Combine input and output options
npx -p bmad-drj bmad-method flatten --input /path/to/source --output /path/to/output/codebase.xml
```
