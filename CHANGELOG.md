...
- chore: remove test directories from commit ([e9f1cc7](https://github.com/DrJLabs/bmad-bp/commit/e9f1cc7))
...
- chore(release): 4.27.3 [skip ci] ([c8b26d8](https://github.com/DrJLabs/bmad-bp/commit/c8b26d8))
...
- adding back the SM with suggestion and rationale to not use it in its current state ([4de795f](https://github.com/DrJLabs/bmad-bp/commit/4de795f))
...
- create-doc2 update ([0ca3f9e](https://github.com/DrJLabs/bmad-bp/commit/0ca3f9e))
...
- Fix typo in instruction.md ([aaed6c1](https://github.com/DrJLabs/bmad-bp/commit/aaed6c1))
...
- Javascript `build-web-agent.js` fixes (#107) ([82bdb3d](https://github.com/DrJLabs/bmad-bp/commit/82bdb3d)), closes [#107](https://github.com/DrJLabs/bmad-bp/issues/107)
...
- Merge pull request #23 from chidev/main ([4697b60](https://github.com/DrJLabs/bmad-bp/commit/4697b60)), closes [#23](https://github.com/DrJLabs/bmad-bp/issues/23)
...
- po agent for ide improvements ([cccfc54](https://github.com/DrJLabs/bmad-bp/commit/cccfc54))
...
- sm agent optimization for ide ([f0239bc](https://github.com/DrJLabs/bmad-bp/commit/f0239bc))
...
- usage-demo through flawed architect gem output and interaction ([3227220](https://github.com/DrJLabs/bmad-bp/commit/3227220))
...
- fix: centralized yamlExtraction function and all now fix character issues for windows ([e2985d6](https://github.com/DrJLabs/bmad-bp/commit/e2985d6))
...
- fix: orchestractor yml ([3727cc7](https://github.com/DrJLabs/bmad-bp/commit/3727cc7))
...
- fix: update glob usage to modern async API ([927515c](https://github.com/DrJLabs/bmad-bp/commit/927515c))
...
- feat: add versioning and release automation ([0ea5e50](https://github.com/DrJLabs/bmad-bp/commit/0ea5e50))
...
- feat: modularize flattener tool into separate components with improved project root detection (#417) ([0fdbca7](https://github.com/DrJLabs/bmad-bp/commit/0fdbca7)), closes [#417](https://github.com/DrJLabs/bmad-bp/issues/417)
...
- docs: add reviewer agent instructions ([30c5537](https://github.com/DrJLabs/bmad-bp/commit/30c5537))
...
- test: trigger PR validation (#533) ([e2e8d44](https://github.com/DrJLabs/bmad-bp/commit/e2e8d44)), closes [#533](https://github.com/DrJLabs/bmad-bp/issues/533)
- test: verify dual publishing workflow ([8a29f0e](https://github.com/DrJLabs/bmad-bp/commit/8a29f0e))
- patch: move script to tools folder ([f3cc410](https://github.com/DrJLabs/bmad-bp/commit/f3cc410))
- Feat(Expansion Pack): Part 1 - Google Cloud Setup ([c7fc5d3](https://github.com/DrJLabs/bmad-bp/commit/c7fc5d3))
- Feat(Expansion Pack): Part 2 - Agent System Templates (#370) ([49347a8](https://github.com/DrJLabs/bmad-bp/commit/49347a8)), closes [#370](https://github.com/DrJLabs/bmad-bp/issues/370)
- add: sync-version.sh script for easy version syncing ([45dd7d1](https://github.com/DrJLabs/bmad-bp/commit/45dd7d1))
- refactor: centralize qa paths in core-config.yaml and update agent activation flows (#451) ([db80eda](https://github.com/DrJLabs/bmad-bp/commit/db80eda)), closes [#451](https://github.com/DrJLabs/bmad-bp/issues/451)
- refactor: nest Claude Code commands under BMad subdirectory (#307) ([97f01f6](https://github.com/DrJLabs/bmad-bp/commit/97f01f6)), closes [#307](https://github.com/DrJLabs/bmad-bp/issues/307)
- refactor: simplify file resolution to concise activation instructions ([d75cf9e](https://github.com/DrJLabs/bmad-bp/commit/d75cf9e))
- refactor: standardize formatting and improve readability across core documents (#211) ([009c77f](https://github.com/DrJLabs/bmad-bp/commit/009c77f)), closes [#211](https://github.com/DrJLabs/bmad-bp/issues/211)
- refactor: Standardize on 'GitHub Copilot' branding (#296) ([9e6940e](https://github.com/DrJLabs/bmad-bp/commit/9e6940e)), closes [#296](https://github.com/DrJLabs/bmad-bp/issues/296)
- refactor: update story naming convention and fix typos ([9172072](https://github.com/DrJLabs/bmad-bp/commit/9172072))
- refactor(gemini-cli): change agent storage from multiple files to single (#308) ([c42002f](https://github.com/DrJLabs/bmad-bp/commit/c42002f)), closes [#308](https://github.com/DrJLabs/bmad-bp/issues/308)
- sync: update package.json to match published version 5.0.1 ([fe318ec](https://github.com/DrJLabs/bmad-bp/commit/fe318ec))
- sync: update to published version 5.1.3 ([f5272f1](https://github.com/DrJLabs/bmad-bp/commit/f5272f1))
- sync: update versions to 5.1.2 to match published release ([26890a0](https://github.com/DrJLabs/bmad-bp/commit/26890a0))
- release: create stable 4.37.0 release ([d21ac49](https://github.com/DrJLabs/bmad-bp/commit/d21ac49))
- release: promote to stable 4.38.0 ([224cfc0](https://github.com/DrJLabs/bmad-bp/commit/224cfc0))
- release: promote to stable 5.0.0 ([f56d37a](https://github.com/DrJLabs/bmad-bp/commit/f56d37a))
- Feature: Installer commands for Crush CLI (#429) ([848e33f](https://github.com/DrJLabs/bmad-bp/commit/848e33f)), closes [#429](https://github.com/DrJLabs/bmad-bp/issues/429)
- eat: enhance flattener tool with improved CLI integration and custom directory support (#372) ([a80ea15](https://github.com/DrJLabs/bmad-bp/commit/a80ea15)), closes [#372](https://github.com/DrJLabs/bmad-bp/issues/372)
- WIP: createdoc2 ([4b0a923](https://github.com/DrJLabs/bmad-bp/commit/4b0a923))
- doc: clarified contributions and guiding principles to align ideals for contribution to BMad Method ([febe7e1](https://github.com/DrJLabs/bmad-bp/commit/febe7e1))
- doc: functional change: fix agent responsibilities link (#64) ([e17ecfc](https://github.com/DrJLabs/bmad-bp/commit/e17ecfc)), closes [#64](https://github.com/DrJLabs/bmad-bp/issues/64)
- doc: readme fixes ([f5fa255](https://github.com/DrJLabs/bmad-bp/commit/f5fa255))
- style: apply formatting fixes and yaml standardization ([49e34f4](https://github.com/DrJLabs/bmad-bp/commit/49e34f4))
- style: apply prettier and yaml formatting ([c5fe28e](https://github.com/DrJLabs/bmad-bp/commit/c5fe28e))

### BREAKING CHANGE

- CI/CD no longer runs automatically in forks.
